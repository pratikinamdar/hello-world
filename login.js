...
Login.prototype.createNewSessionId = function(mySessionId) {
        var n_sessionId = new Date().getTime();
 var _name = this.sessionMap[mySessionId].name;
        var _email = this.sessionMap[mySessionId].email;
        this.sessionMap[n_sessionId] = { name: _name, email: _email }
delete this.sessionMap[mySessionId];
